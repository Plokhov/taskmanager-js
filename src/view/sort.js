  ...
  getTemplate() {
    return (
      `<div class="board__filter-list">
        ...
        <a
          href="#"
          class="board__filter ${this._currentSortType === SortType.DATE_UP ? `board__filter--active` : ``}"
        ...
        <a
          href="#"
          class="board__filter ${this._currentSortType === SortType.DATE_DOWN ? `board__filter--active` : ``}"
